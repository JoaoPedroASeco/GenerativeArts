...
function heart(state) {
  ...
  beginShape();
  vertex(state.pos.x, state.pos.y);
  bezierVertex(state.pos.x - 100 / 2, state.pos.y - 100 / 2, state.pos.x - 100, state.pos.y + 100 / 3, state.pos.x, state.pos.y + 100);
  bezierVertex(state.pos.x + 100, state.pos.y + 100 / 3, state.pos.x + 100 / 2, state.pos.y - 100 / 2, state.pos.x, state.pos.y);
  endShape(CLOSE);
}
